...
class Personal(QWidget):
    def __init__(self, login):
        ...
        self.make.clicked.connect(self.makemoney)
        self.hide_tranfer()
        self.transfer.clicked.connect(self.user_tranfer)

    def hide_tranfer(self):
        self.result.hide()
        self.login.hide()
        self.amout.hide()
        self.send.hide()
    ...
    def makemoney(self):
        ...
        self.db.connect.commit()
        self.update_balance()
    def user_tranfer(self):
        self.show_transfer()
        login = self.login.text()
        amout = self.amout.text()
        cursor = self.db.connect.cursor()
